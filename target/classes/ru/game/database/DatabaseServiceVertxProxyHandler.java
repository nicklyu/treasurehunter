  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "fetchLevelArea": {
          service.fetchLevelArea(json.getValue("levelId") == null ? null : (json.getLong("levelId").intValue()), createHandler(msg));
          break;
        }
        case "fetchLevelTreasure": {
        ...
        case "fetchAdminLevel": {
          service.fetchAdminLevel(json.getValue("levelId") == null ? null : (json.getLong("levelId").intValue()), createHandler(msg));
          break;
        }
