...
public class DatabaseServiceVertxEBProxy implements DatabaseService {
  ...
  public DatabaseService fetchLevelArea(int levelId, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("levelId", levelId);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "fetchLevelArea");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public DatabaseService fetchLevelTreasure(int levelId, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("levelId", levelId);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "fetchLevelTreasure");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public DatabaseService fetchAllTips(int levelId, Handler<AsyncResult<JsonArray>> resultHandler) {
    ...
    _json.put("levelId", levelId);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "fetchAllTips");
    _vertx.eventBus().<JsonArray>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
  ...
  public DatabaseService fetchAdminLevel(int levelId, Handler<AsyncResult<JsonObject>> resultHandler) {
    ...
    _json.put("levelId", levelId);
    DeliveryOptions _deliveryOptions = (_options != null) ? new DeliveryOptions(_options) : new DeliveryOptions();
    _deliveryOptions.addHeader("action", "fetchAdminLevel");
    _vertx.eventBus().<JsonObject>send(_address, _json, _deliveryOptions, res -> {
      if (res.failed()) {
        resultHandler.handle(Future.failedFuture(res.cause()));
      } else {
